  ...
  return (function (e) {
      ...
      var y = (function (e) {
        function t(e) {
          ...
          return (
            ...
            (i.confirmEl =
              i.pickerEl.getElementsByClassName('confirm-hook')[0]),
            (i.cancelEl = i.pickerEl.getElementsByClassName('cancel-hook')[0]),
            (i.scrollEl =
              i.pickerEl.getElementsByClassName('wheel-scroll-hook')),
            i._init(),
            i
          )
        }
                      ...
                      'string' == typeof this.options.snap &&
                        ...
                        this.on('refresh', function () {
                          if (
                            ...
                            if (e.options.snap === !0)
                              for (
                                o = Math.round(t / 2), s = Math.round(i / 2);
                                n > -e.scrollerWidth;
                              ...
                              for (
                                u = e.options.snap, h = u.length, p = -1;
                                l < h;
                                l++
                              )
                                (f = (0, a.getRect)(u[l])),
                                  (0 === l ||
                                    f.left <= (0, a.getRect)(u[l - 1]).left) &&
                                    ((c = 0), p++),
                                  e.pages[c] || (e.pages[c] = []),
                            ...
                            e.goToPage(
                              ...
                              e.options.snapThreshold % 1 === 0
                                ? ((e.snapThresholdX = e.options.snapThreshold),
                                  (e.snapThresholdY = e.options.snapThreshold))
                                : ((e.snapThresholdX = Math.round(
                                    e.pages[e.currentPage.pageX][
                                      e.currentPage.pageY
                                    ].width * e.options.snapThreshold
                                  )),
                                  (e.snapThresholdY = Math.round(
                                    e.pages[e.currentPage.pageX][
                                      e.currentPage.pageY
                                    ].height * e.options.snapThreshold
                                  )))
                          }
                        }),
                        ...
                        this.on('flick', function () {
                          var t =
                            ...
                            Math.max(
                              Math.max(
                                Math.min(Math.abs(e.x - e.startX), 1e3),
                                Math.min(Math.abs(e.y - e.startY), 1e3)
                              ),
                              300
                            )
                          e.goToPage(
                        ...
                        if (
                          ...
                          this._translate(i.x, i.y),
                            this.options.wheel
                              ? (this.target =
                                  this.items[
                                    Math.round(-i.y / this.itemHeight)
                                  ])
                      ...
                      if (
                        ...
                        if (!this.moved) {
                          if (this.options.wheel) {
                            ...
                            this.options.tap && (0, a.tap)(e, this.options.tap),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      function e() {
                        ...
                        t.trigger('scroll', i),
                          t.isInTransition &&
                            (t.probeTimer = (0, a.requestAnimationFrame)(e))
                      }
                    ...
                    value: function () {
                      ...
                      if (
                        ...
                        for (var i = 0; i < this.items.length; i++)
                          this.items[i].style[a.style.transitionDuration] =
                            t + 'ms'
                      !t &&
                        a.isBadAndroid &&
                        ((this.scrollerStyle[a.style.transitionDuration] =
                        ...
                        (0, a.requestAnimationFrame)(function () {
                          '0.0001ms' ===
                            e.scrollerStyle[a.style.transitionDuration] &&
                            (e.scrollerStyle[a.style.transitionDuration] = '0s')
                        }))
                    },
                  },
                  {
                    ...
                    value: function (e) {
                      if (
                        ((this.scrollerStyle[a.style.transitionTimingFunction] =
                          e),
                        this.options.wheel && !a.isBadAndroid)
                      )
                  ...
                  },
                  {
                    ...
                    value: function (e, t) {
                      if (
                        ...
                        for (var i = 0; i < this.items.length; i++) {
                          var n =
                            this.options.rotate * (t / this.itemHeight + i)
                    ...
                    value: function (e, t, i) {
                      ...
                      ;(i =
                        void 0 === i
                          ...
                          : i),
                        (this.currentPage = { x: r, y: o, pageX: e, pageY: t }),
                    ...
                    value: function (e) {
                      switch (e.type) {
                        ...
                        case 'click':
                          !this.enabled ||
                            e._constructed ||
                            /(SELECT|INPUT|TEXTAREA)/i.test(e.target.tagName) ||
          ...
          function (e, t) {
            ...
            function i(e) {
              return (
                ...
                ('standard' === f
                  ? e
                  : f + e.charAt(0).toUpperCase() + e.substr(1))
              )
            }
            function n(e, t, i, n) {
    ...
    function (e, t) {
      ...
      function i(e, t) {
        ...
        t &&
          t.firstLine &&
          ((i = t.firstLine), (e += ' - ' + i + ':' + t.firstColumn))
        for (
          var r = Error.prototype.constructor.call(this, e), o = 0;
          o < n.length;
          o++
        )
          this[n[o]] = r[n[o]]
      ...
      function r(e, t) {
        ...
        var i = function (e, i, n, r, o, s) {
            ...
            if (t.compile) {
              ...
              return (
                (o[i] = t.compile(e, { data: void 0 !== s }, t)), o[i](n, l)
              )
            }
            throw new c(
              'The partial ' +
          ...
          n = {
            ...
            program: function (e, t, i) {
              ...
              return (
                i ? (n = s(e, t, i)) : n || (n = this.programs[e] = s(e, t)), n
              )
            },
            merge: function (e, t) {
              var i = e || t
              return (
                e && t && e !== t && ((i = {}), h.extend(i, t), h.extend(i, e)),
                i
              )
            },
    ...
    function (e, t, i) {
      ;(t = e.exports = i(17)()),
        t.push([
          e.id,
          '.picker{display:none;position:fixed;top:0;z-index:100;width:100%;height:100%;overflow:hidden;text-align:center;font-family:PingFang SC,STHeitiSC-Light,Helvetica-Light,arial,sans-serif;font-size:14px;-moz-user-select:none;-webkit-user-select:none;-ms-user-select:none;user-select:none}.picker .picker-mask{position:absolute;z-index:500;width:100%;height:100%;transition:all .5s;-webkit-transition:all .5s;background:transparent;opacity:0}.picker .picker-mask.show{background:rgba(0,0,0,.6);opacity:1} .picker-panel{position:absolute;z-index:600;bottom:0;width:100%;background:#fff;transform:translateY(4.86rem);-webkit-transform:translateY(4.86rem);transition:all .5s;-webkit-transition:all .5s}.picker .picker-panel.show{transform:translateY(0);-webkit-transform:translateY(0)}.picker .picker-panel .picker-choose{overflow:hidden;display:flex; justify-content: space-between;align-items: center;height:1rem;color:#878787;font-size:0.28rem;border-bottom: 1px solid rgba(213, 213, 213, 0.9);}.picker .picker-panel .picker-choose .picker-title{line-height:1rem;font-size:0.38rem;text-align:center;color:#333}.picker .picker-panel .picker-choose .cancel,.picker .picker-panel .picker-choose .confirm{ }.picker .picker-panel .picker-choose .confirm{right:0;}.picker .picker-panel .picker-choose .cancel{left:0}.picker .picker-panel .picker-content{position:relative}.picker .picker-panel .picker-content .mask-bottom,.picker .picker-panel .picker-content .mask-top{position:absolute;z-index:10;width:100%;height:1.36rem;pointer-events:none;transform:translateZ(0);-webkit-transform:translateZ(0)}.picker .picker-panel .picker-content .mask-top{top:0;background:-webkit-gradient(linear,left bottom,left top,from(hsla(0,0%,100%,.02)),to(hsla(0,0%,100%,.5)));background:-o-linear-gradient(bottom,hsla(0,0%,100%,.4),hsla(0,0%,100%,.8))}.picker .picker-panel .picker-content .mask-top:after,.picker .picker-panel .picker-content .mask-top:before{display:block;position:absolute;border-top:1px solid #ccc;left:0;width:100%;content:" "}.picker .picker-panel .picker-content .mask-top:before{display:none;top:0}.picker .picker-panel .picker-content .mask-top:after{display:block;bottom:0}.picker .picker-panel .picker-content .mask-bottom{bottom:0;background:-webkit-gradient(linear,left bottom,left top,from(hsla(0,0%,100%,.5)),to(hsla(0,0%,100%,.02)));background:-o-linear-gradient(top,hsla(0,0%,100%,.4),hsla(0,0%,100%,.8))}.picker .picker-panel .picker-content .mask-bottom:after,.picker .picker-panel .picker-content .mask-bottom:before{display:block;position:absolute;border-top:1px solid #ccc;left:0;width:100%;content:" "}.picker .picker-panel .picker-content .mask-bottom:before{display:block;top:0}.picker .picker-panel .picker-content .mask-bottom:after{display:none;bottom:0}.picker-content{background-color: #dedede;} .picker .picker-panel .wheel-wrapper{display:-ms-flexbox;display:-webkit-box;display:flex;padding:0 10px; }.picker .picker-panel .wheel-wrapper .wheel{-ms-flex:1 1 1e-9px;-webkit-box-flex:1;flex:1;flex-basis:1e-9px;width:1%;height:3.46rem;overflow:hidden;font-size:0.35rem}.picker .picker-panel .wheel-wrapper .wheel .wheel-scroll{margin-top:1.36rem;line-height:0.72rem}.picker .picker-panel .wheel-wrapper .wheel .wheel-scroll .wheel-item{height:36px;overflow:hidden;white-space:nowrap;color:#333}.picker .picker-footer{}@media (-webkit-min-device-pixel-ratio:1.5),(min-device-pixel-ratio:1.5){.border-1px:after,.border-1px:before{-webkit-transform:scaleY(.7);-webkit-transform-origin:0 0;transform:scaleY(.7)}.border-1px:after{-webkit-transform-origin:left bottom}}@media (-webkit-min-device-pixel-ratio:2),(min-device-pixel-ratio:2){.border-1px:after,.border-1px:before{-webkit-transform:scaleY(.5);transform:scaleY(.5)}}',
          '',
        ])
    },
    function (e, t) {
